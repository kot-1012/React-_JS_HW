...
import topBrandImage from "../images/top_brand_img.png";

import { HandySvg } from "handy-svg";
import topBrandTitle from "../images/top_brand_title.svg";

import { ReactComponent as FeatureDeliveryIcon } from "../images/feature_icon1.svg";
import { ReactComponent as FeatureDiscountIcon } from "../images/feature_icon2.svg";
import { ReactComponent as FeatureQualityIcon } from "../images/feature_icon3.svg";
            ...
            <content className="content">
                <div className="top_brand">
                    <div className="top_brand_img">
                        <img className="top_brand_pic" src={topBrandImage} alt="Man" />
                    </div>
                    <div className="top_brand_title">
                        <HandySvg src={topBrandTitle} width="12" height="93" />
